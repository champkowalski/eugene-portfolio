...
const Hero = () => {
  const { data, isLoading, error } = useResources({
    url: metaUrl.user_profile,
    queryKey: ["resource", metaUrl.user_profile],
  });
  return (
    <section id="home" className="pt-24 pb-12 bg-gradient-to-br from-blue-50 to-white">
      <div className="max-w-[85rem] mx-auto mt-10 px-4 sm:px-6 lg:px-8">
        {isLoading && <Loader className="text-center animate-spin" />}
        {data && data.length > 0 && (
          <div className="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
            <div>
              ...
              <p className="mt-3 text-lg text-gray-800">{data[0].bio}</p>
