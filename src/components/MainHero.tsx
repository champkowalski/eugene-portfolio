      ...
      <div className="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
        <div>
          ...
          <p className="mt-3 text-lg text-gray-800">
            Analytical and detail-oriented Information Systems expert / Data Analyst with experience in human resources,
            bioinformatics & marketing. I specialize in creating interactive dashboards, building data models,
            information system implementations and management. I am skilled in gathering and analyzing data to provide
            actionable insights using Power BI & MS Excel to streamline business operations, and support
            decision-making.
          </p>
        ...
        <div className="relative ms-4">
          <img className="w-full h-96 rounded-md object-cover" src="/eugene-1.jpeg" alt="Hero Image" />
